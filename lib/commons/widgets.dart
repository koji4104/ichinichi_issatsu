...
const ICON_BUTTON_SIZE_BOTTOM = 28.0;

const double DEF_VIEW_LINE_WIDTH = DEF_VIEW_PADDING_W + DEF_VIEW_PADDING_W + 6;
...
Widget MyText(String text, {int? maxLength, int? maxLines, bool? noScale, bool? center, bool? small}) {
