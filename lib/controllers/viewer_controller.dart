...
class ViewerController {
  ...
  Future<bool> jumpToIndex1(int index, int ratio) async {
    if (scrollCtrl == null) return true;
    isJumping = true;
    ...
    try {
      ...
      int curdx = scrollCtrl!.position.pixels.toInt();
...
""";
  ...
  Widget viewer(Environment env, ViewerBarType barType) {
